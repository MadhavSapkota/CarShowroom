<!-- This is the code for cars_template  -->
<!-- Name:Madhav Sapkota
UNID:17429433 
Web_assignment2
...
<?php
		...
		?>
			...
			foreach ($stmt as $car) {
				...
				if($car['status'] == 'none'){
					echo '<td><a style="float: right" href="cars?id=' . $car['id'] . '">Archieve</a></td>';
				}
				else {
					echo '<td><a style="float: right" href="cars?id=' . $car['id'] . '">Unarchieve</a></td>';
				}
